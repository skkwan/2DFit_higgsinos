...
mu_peaking_met = ROOT.RooRealVar('mu_peaking_met', 'mu_peaking_met', 225, 100, 300)
b_peaking_met = ROOT.RooRealVar('b_peaking_met', 'b_peaking_met', 40, 5, 100)
...
mu_total_met = ROOT.RooRealVar('mu_total_met', 'mu_total_met', 225, 100, 300)
b_total_met = ROOT.RooRealVar('b_total_met', 'b_total_met', 40, 5, 100)
bkg_total_met_pdf = ROOT.RooGenericPdf("bkg_total_met", "bkg_total_met", "1/b_total_met * exp(-(@0 - mu_total_met)/b_total_met - exp(-(@0 - mu_total_met)/b_total_met))",
                        ROOT.RooArgList(met, mu_total_met, b_total_met))
# Fit
...
f = ROOT.TFile("fitresult_background_MET_gumbel.root", "RECREATE")
