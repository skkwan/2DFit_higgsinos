...
def plotFit(name, rooVar, dataset, pdf, dataLabel, fitLabel, plotname,
    ...
    # This needs to be reset at the top of each function
    CMS.SetCmsTextFont(62)
    CMS.SetCmsTextSize(0.76)
    CMS.SetLumi("")
